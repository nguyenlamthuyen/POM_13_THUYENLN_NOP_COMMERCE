...
public class RegisterPageUI {
	public static String GENDER_MALE_RADIO = "//input[@id='gender-male']";
	public static String FIRST_NAME_TEXTBOX = "//input[@id='FirstName']";
	public static String LAST_NAME_TEXTBOX = "//input[@id='LastName']";
	public static String DATE_DROPDOWN = "//select[@name='DateOfBirthDay']";
	public static String MONTH_DROPDOWN = "//select[@name='DateOfBirthMonth']";
	...
	public static String REGISTER_SUCCESS_TEXT = "//div[@class='result']";
